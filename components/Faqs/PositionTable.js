            ...
            <Accordion>
                <Card>
                    ...
                    <Accordion.Collapse eventKey='0'>
                        <Card.Body>
                            <ol>
                                <li><p>Margin requirements are automatically controlled by <a href='https://dev.traderscentral.com/bagley-score' target='_blank' rel='noreferrer'>Bagley</a>, floating between the range of 1 to 1.7 and depending on currency exchange rates and market volatility.</p></li>
                                <li><p>During the winter wind-down (December to February), and summer slowdown (June to August) Bagley automatically adjusts lot sizing to the lower end of the margin requirements band. During the volatility months (March to May & September to December) Bagley automatically adjusts lot sizing to the higher end of the margin requirements band.</p></li>
                                <li><p>In Market crashes and black swan events, when there’s a cascade of liquidations, Bagley will keep adjusting the margin requirements automatically.</p></li>
