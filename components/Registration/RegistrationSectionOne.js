            ...
            <a
              onClick={e => {
                ...
                if (secondCheck) {
                  ...
                  props.setData({
                    ...props.data,
                    interested_services: 'Portfolio Tracking (for my users)'
                  })
                  props.servicesAdded('volume')
                }
              }}
    ...
    <div className='eleventh'>
      <div className='form-section'>
        ...
        <form action=''>
          ...
          {facebookError ? (
            <p className='error'>Facebook profile is required.</p>
          ) : null}

          {instagramError ? (
            <p className='error'>Instagram profile is required.</p>
          ) : null}

          {telegramError ? (
            <p className='error'>Telegram profile is required.</p>
          ) : null}
