...
export default function StationSectionFive() {
  return (
    <div className="stationSectionFive stationStyle floatContentWrap pt-5">
          ...
          <div className="col-12 col-md-4 col-md-4">
            <div className="row">
              <div className="col-12 mb-3">
                <a href="#">
                  <div className="newsLeftSectionImg">
                    <Image src="/images/station/D_I_010721_2500x2500x_Magazine_Square_Large.webp" alt="Image" width={480} height={480} />
                  </div>
              ...
              <div className="col-12 mb-3">
                <a href="#">
                  <div className="newsLeftSectionImg">
                    <Image src="/images/station/20-12_Josh-Ferris_1900x1900_Magazine_Square_Small.webp" alt="Image" width={480} height={480} />
                  </div>
                  <div className="newsContent">
                    <span>Money & the World</span>
                    <h3>
              ...
              <div className="col-12 mb-3">
                <a href="#">
                  <div className="newsLeftSectionImg">
                    <Image src="/images/station/Giving_1900x1900.webp" alt="Image" width={480} height={480} />
                  </div>
                  <div className="newsContent">
                    <span>Money & the World</span>
                    <h3>
