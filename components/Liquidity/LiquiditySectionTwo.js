...
export default function LiquiditySectionTwo({tl}) {
    useEffect(() => {
        ...
        .add('start')
        .from(".liquiditySectionTwo .gaspSlideLeft", { x: -50, opacity : 0 }, 'start')
        .from(".liquiditySectionTwo .gaspSlideRight", { x: 50, opacity : 0 }, 'start');
    }, [tl]);
  return (
            ...
            <div className="row py-5 d-flex align-items-stretch">
                ...
                <div className="col-12 col-md-6 gaspSlideRight d-flex align-items-center">
                    <div className="tradingBasicHP">
                        ...
                        <p>For ambitious founders around the world, we make starting a local fund as simple, borderless and programable as the resr of the internet.</p>
                    </div>
                </div>
            </div>
        </div>
