...
export default function LiquiditySectionFive({tl}) {
    useEffect(() => {
        gsap.timeline({
            scrollTrigger: {
        ...
        .add('start')
        .from(".liquiditySectionFive .gaspSlideLeft", { x: -50, opacity : 0 }, 'start')
        .from(".liquiditySectionFive .gaspSlideRight", { x: 50, opacity : 0 }, 'start');
    }, [tl]);
  return (
            ...
            <div className="row py-5 d-flex align-items-stretch">
                ...
                <div className="col-12 col-md-6 gaspSlideRight d-flex align-items-center">
                    <div className="tradingBasicHP">
                        <h2>Confidential & secure to use</h2>
                        <ul className="csuList">
                            <li>Partner funds identities  are secured by nondisclosure agreements</li>
                            <li>Partner funds traders data are secured with state-of-the-art encryption</li>
