...
export default function LiquiditySectionFour({tl}) {
    useEffect(() => {
        gsap.timeline({
            scrollTrigger: {
        ...
        .add('start')
        .from(".liquiditySectionFour .gaspSlideLeft", { x: -50, opacity : 0 }, 'start')
        .from(".liquiditySectionFour .gaspSlideRight", { x: 50, opacity : 0 }, 'start');
    }, [tl]);
  return (
            ...
            <div className="row py-5 d-flex align-items-stretch">
                ...
                <div className="col-12 col-md-6 gaspSlideRight d-flex align-items-center">
                    <div className="tradingBasicHP">
                        ...
                        <p>Plans are equipped with automated backoffice systems, branded MT5 labels and traders analytics</p>
                    </div>
                </div>
