...
export default function LiquiditySectionThree({tl}) {
    useEffect(() => {
        gsap.timeline({
            scrollTrigger: {
        ...
        .add('start')
        .from(".liquiditySectionThree .gaspSlideLeft", { x: -50, opacity : 0 }, 'start')
        .from(".liquiditySectionThree .gaspSlideRight", { x: 50, opacity : 0 }, 'start');
    }, [tl]);
  return (
            ...
            <div className="row py-5 d-flex align-items-stretch">
                ...
                <div className="col-12 col-md-6 gaspSlideLeft d-flex align-items-center">
                    <div className="tradingBasicHP ">
                        ...
                        <p>The personalized portal allows you to manage all your traders and process their tasks.</p>
                    </div>
                </div>
