...
export default function AboutUsSectionJotc({tl}) {
  useEffect(() => {
    ...
    .add('start')
    .from(".aboutUsSectionJotc .gaspSlideLeft", { x: -50, opacity : 0 }, 'start')
    .from(".aboutUsSectionJotc .gaspSlideRight", { x: 50, opacity : 0 }, 'start');
  }, [tl]);
  return (
        ...
        <div className="row d-flex align-items-center helpCenterSectionFiveOne">
          <div className="col-12 col-md-6 gaspSlideLeft">
            <div className="sectionTitleWrap mb-5 ">
              ...
              <a className=" btn btn-black px-3 py-1" href="https://t.me/Traderscentralchatroom" target="_blank">
                Accept Invite
              </a>
            </div>
          </div>
