...
export default function TradingBasicSectionTwo({tl}) {
  useEffect(() => {
    gsap.timeline({
      scrollTrigger: {
          ...
          <div className="row py-5 d-flex align-items-stretch">
            <div className="col-12 col-md-6 mb-4 gaspSlideLeft">
              <div className="tradingBasicV">
                <video id="myVideo" loop={true} autoPlay="autoplay" muted={true}>
            ...
            <div className="col-12 col-md-6 d-flex align-items-center mb-4 gaspSlideRight">
              <div className="tradingBasicHP">
                <h2>A demystifying series to fulfill your financial desires </h2>
                <p>
        ...
        <div className="row py-5 d-flex align-items-stretch">
          ...
          <div className="col-12 col-md-6 mb-4 gaspSlideRight">
            <div className="tradingBasicI">
              <Image src="/images/trading-basicDbfy.png" alt="Daily bites to fill your belly" width={540} height={568} />
            </div>
          </div>
        </div>
      </div>
