...
export default function TradingBasicSectionThree({tl}) {
  useEffect(() => {
    ...
    .add('start')
    .from(".tradingBasicSectionThree .sectionTitleWrap", { y: -50, opacity : 0, duration: 0.8 }, 'start')
    .from(".tradingBasicSectionThree .smallCard1", { x: -50, opacity : 0, duration: 0.8 }, 'start')
    .from(".tradingBasicSectionThree .smallCard2", { x: 50, opacity : 0, duration: 0.8 }, 'start')
    .from(".tradingBasicSectionThree .smallCard3", { x: -50, opacity : 0, duration: 0.8 }, 'start')
    .from(".tradingBasicSectionThree .smallCard4", { x: 50, opacity : 0, duration: 0.8 }, 'start')
    .from(".tradingBasicSectionThree .smallCard5", { x: -50, opacity : 0, duration: 0.8 }), 'start';
  }, [tl]);
  return (
    <div className="tradingBasicSectionThree py-5 d-flex align-items-center heightHv">
      <div className="container">
        ...
        <div className="row pt-5 d-flex justify-content-center tradingBasicCCB">
          <div className="col-12 col-lg-8 gaspSlideLeft">
            <div className=" smallCard smallCardOne smallCard1 card flex-md-row mb-3">
              <Image
            ...
            <div className=" smallCard smallCardOne smallCard2 card flex-md-row mb-3">
              <Image
                className="card-img-right flex-auto d-none d-md-block"
              ...
              <div className="card-body  d-flex align-items-stretch ">
                <div className="d-flex align-items-end">
                  <div className="card-body-four-line">
                    ...
                    <h5 className="card-title">Crypto currencies</h5>
                    <p className="card-text">
            ...
            <div className=" smallCard smallCardOne smallCard3 card flex-md-row mb-3">
              <Image
                className="card-img-right flex-auto d-none d-md-block"
            ...
            <div className=" smallCard smallCardOne smallCard4 card flex-md-row mb-3">
              <Image
                className="card-img-right flex-auto d-none d-md-block"
              ...
              <div className="card-body  d-flex align-items-stretch ">
                <div className="d-flex align-items-end">
                  <div className="card-body-four-line">
                    ...
                    <h5 className="card-title">Psychology and Risk</h5>
                    <p className="card-text">
