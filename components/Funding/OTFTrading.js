          ...
          <Card.Body>
            ...
            <Card>
                ...
                <Accordion.Collapse eventKey='7'>
                    <Card.Body>
                        You can reduce your lot size by up to 75% of the average lot size used on all of your challenge
                        trades until now. You can’t use 0.01 lot sizes or any amount lower than one-fourth of the
                        average lot size used till now on your challenge. You will also be expected to trade normally on
                        the reduced lot size to not by pass the minim day rule.
                    </Card.Body>
                </Accordion.Collapse>
            </Card>
