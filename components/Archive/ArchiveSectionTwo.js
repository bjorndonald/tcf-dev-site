...
export default function ArchiveSectionTwo () {
  //   useEffect(() => {
  //     gsap.timeline({
  //       scrollTrigger: {
    ...
    <div className='archiveSectionTwo py-5 d-flex align-items-center overFlowH'>
      <div className='container'>
        <div className='row theArchiveFourWrap'>
            ...
            <div className='card'>
              ...
              <div className='videoWrapperSli player-wrapper'>
                <ReactPlayer
                  ...
                  url='https://www.youtube.com/watch?v=Tblulp7K7_c&list=PLcXoX4iSJOx8hxJ7F95JJPEJL52Tk9NOJ'
                  loop={true}
                  controls={false}
                  muted={true}
                />
          ...
          <div
            className='col-12 col-md-6 my-3 theArchiveFourBox theArchiveFourBox2'
            width={538}
            height={255}
          >
            <div className='card'>
              ...
              <div className='videoWrapperSli player-wrapper'>
                <ReactPlayer
                  className='react-player'
                  url='https://www.youtube.com/watch?v=gUFFlVrOY9M&list=PLcXoX4iSJOx99Cr6Mckhx4aQS_ikBZGdZ'
                  loop={true}
                  controls={false}
                  muted={true}
                />
          ...
          <div className='col-12 col-md-6 my-3 theArchiveFourBox theArchiveFourBox3'>
            <div className='card'>
              ...
              <div className='videoWrapperSli player-wrapper'>
                <ReactPlayer
                  className='react-player'
                  url='https://www.youtube.com/watch?v=Ha6r5mKI6_o&list=PLcXoX4iSJOx82Ge5MGjYU5uOqWAA1xzCa'
                  loop={true}
                  controls={false}
                  muted={true}
                />
          ...
          <div className='col-12 col-md-6 my-3 theArchiveFourBox theArchiveFourBox4'>
            <div className='card'>
              ...
              <div className='videoWrapperSli player-wrapper'>
                <ReactPlayer
                  className='react-player'
                  url='https://www.youtube.com/watch?v=D1X5SuR-24M&list=PLcXoX4iSJOx_eE3TNAPU98cSfL_HBrWb3'
                  loop={true}
                  controls={false}
                  muted={true}
                />
