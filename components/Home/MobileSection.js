          ...
          <div className='row d-flex align-items-stretch'>
            ...
            <div className='col-12 col-md-6'>
              <div className='sectionTwoContentWrap'>
                <div className='sectionTwoContent sectionTwoContent-1 d-flex flex-column justify-content-between'>
                  <h2>
                ...
                <div className='sectionTwoContent sectionTwoContent-2 d-flex flex-column justify-content-between'>
                  <h2>
                    <div className='sectionTwoContentLine sectionTwoContentLineOne'>
                      <div className='sectionTwoContentLineOneInner '>
                        Socials Function
                ...
                <div className='sectionTwoContent sectionTwoContent-3 d-flex flex-column justify-content-between'>
                  <h2>
                    <div className='sectionTwoContentLine sectionTwoContentLineOne'>
                      <div className='sectionTwoContentLineOneInner'>
