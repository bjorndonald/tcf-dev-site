...
function AltMonthly (props) {
  ...
  return (
    <div className='col-12 col-md-5 d-flex justify-content-start monthly'>
      {' '}
                ...
                <OverlayTrigger
                  ...
                  overlay={
                    <Tooltip>
                      ...
                      Indices needs to be unlocked in your portfolio to confirm
                      your eligibility.
                    </Tooltip>
                  }
                >
            ...
            <li>
              <p>
                ...
                <OverlayTrigger
                  ...
                  overlay={
                    <Tooltip>
                      Profit share to the trader on the 12,500 & 25,000 account
                      is 60%. On the 50,000 account it is 55%
                    </Tooltip>
                  }
                >
                  <span className='pTableiconWrap'>
